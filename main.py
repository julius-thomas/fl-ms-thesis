...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_workers', help='per-client DataLoader workers (0 disables multiprocessing; recommended for small datasets like MNIST)', type=int, default=0)
