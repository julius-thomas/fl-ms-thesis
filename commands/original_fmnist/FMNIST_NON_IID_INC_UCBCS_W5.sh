...
# UCB candidate sampling + stoch final selection on Fashion-MNIST Dirichlet non-IID incremental (hard blur) drift,
...
python3 main.py \
    --exp_name "FMNIST_NON_IID_INC_UCBCS_W5${EXP_SUFFIX}" --seed ${SEED} --device cuda \
    ...
    --candidate_sampling ucb --ucb_c 1.0 --ucb_variant sliding --ucb_window 5 \
    --max_grad_norm 10 \
