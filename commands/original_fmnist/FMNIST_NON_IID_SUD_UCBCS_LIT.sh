...
# pathological non-IID with sudden label-swap drift (rounds 40-60).
# Paper FMNIST settings: K=100, C=0.03 (m=3 trained per round), gamma=0.9 (alpha=0.3 regime).
