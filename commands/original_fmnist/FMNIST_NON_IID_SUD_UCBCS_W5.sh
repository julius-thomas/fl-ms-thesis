...
# UCB candidate sampling + stoch final selection on Fashion-MNIST Dirichlet non-IID sudden drift,
...
python3 main.py \
    --exp_name "FMNIST_NON_IID_SUD_UCBCS_W5${EXP_SUFFIX}" --seed ${SEED} --device cuda \
