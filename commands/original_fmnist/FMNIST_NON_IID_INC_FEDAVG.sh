...
# FedAvg baseline on Fashion-MNIST, Dirichlet non-IID (alpha=0.3), incremental hard-blur drift (rounds 40-60).
...
python3 main.py \
    --exp_name "FMNIST_NON_IID_INC_FEDAVG${EXP_SUFFIX}" --seed ${SEED} --device cuda \
