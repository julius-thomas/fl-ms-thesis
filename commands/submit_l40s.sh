...
# Usage:
#   sbatch commands/submit_l40s.sh commands/mimic/vanilla.sh                  # single run, seed=42
#   sbatch --array=0-4 commands/submit_l40s.sh commands/mimic/vanilla.sh      # 5 reps, seeds 42..46
