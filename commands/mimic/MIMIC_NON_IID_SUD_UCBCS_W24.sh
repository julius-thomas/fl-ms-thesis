...
python3 main.py \
    --exp_name "MIMIC_NON_IID_SUD_UCBCS_W24${EXP_SUFFIX}" --seed ${SEED} --device mps \
    ...
    --K 20 --R 600 --E 1 --C 0.5 --B 256 --beta1 0 \
    --active_sampling --sampling_fraction 0.5 --sampling_type stoch --temp 0.5 \
    --candidate_sampling ucb --ucb_c 1.0 --ucb_variant sliding --ucb_window 24 \
