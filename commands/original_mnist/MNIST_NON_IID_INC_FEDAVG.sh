...
# FedAvg baseline on MNIST, pathological non-IID, incremental hard-blur drift (rounds 40-60).
...
python3 main.py \
    --exp_name "MNIST_NON_IID_INC_FEDAVG${EXP_SUFFIX}" --seed ${SEED} --device cuda \
    --dataset MNIST \
