...
# Candidate set small: C=0.2 (20/100 candidates), sampling_fraction=0.5 → train 10 highest-loss per round.
python3 main.py \
    --exp_name MNIST_NON_IID_SUD_MAXCS_CSMALL --seed 42 --device cuda \
    --dataset MNIST \
