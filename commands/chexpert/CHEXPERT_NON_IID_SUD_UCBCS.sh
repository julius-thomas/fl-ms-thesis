...
python3 main.py \
    --exp_name "FedAvg_CheXpert_ResNet18_UCBStoch${EXP_SUFFIX}" --seed ${SEED} --device cuda --bf16 \
    ...
    --K 20 --R 150 --E 2 --C 0.5 --B 16 --beta1 0 \
    --active_sampling --sampling_fraction 0.5 --sampling_type stoch --temp 1 \
